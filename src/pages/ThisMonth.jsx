...
const RECURRING_EXPENSES = [
  ...
  new (function() {
    ...
    // 0 is Sunday
    const firstDayOfMonth = new Date(`${TODAY.getMonth()+1}/1/${TODAY.getFullYear()}`);
    ...
    while (lastTueOfMonth.getMonth() === TODAY.getMonth()) {
  ...
  return (
    <div className="next-month">
      ...
      <section className="total">
        <h2>Total for {dateUtils.format(TODAY, "MMM")}: { printMoney(totalExpenses, false) }</h2>
      </section>
    </div>
  )
}